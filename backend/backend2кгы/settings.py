...
USER_AGENTS = [b for v in UserAgent(browsers=['edge', 'chrome']).data_browsers.values() for b in v]
USE_PROXIES = None
PROXIES = [{}, ]
#     # tor
#     {
...
RADING_VIEW_API_LOGGER = add_named_logger("trading_view_logger")
...
TELETHONE_PROXY = os.getenv('TELETHONE_PROXY').split(':')
if len(TELETHONE_PROXY) == 5:
