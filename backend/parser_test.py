    ...
    html.Div(children=[
        html.Div(children=[
            dash_table.DataTable(id="ask_table", style_header={"display": "none"},
                                 style_cell={"mindWidth": "140", "maxWidth": "140px", "width": "140px",
                                             "text-align": "center"}),
...
def update_orderbook(agg_level, quantity_precision, price_precision, symbol, n):
    url = "https://binance.com/api/v1/depth"
...
if __name__ == "__main__":
    update_orderbook = update_orderbook(10, 1, 1, 'BCHUSDT', 1)
    print(update_orderbook)
